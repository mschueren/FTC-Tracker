        ...
        ?>
            <select id="teams">
                ...
                <?php
                    ...
                    $results = $conn->query("SELECT Team.TeamNumber, Team.Name FROM TeamEvent JOIN (Team, Event) ON (Team.TeamNumber = TeamEvent.TeamId AND TeamEvent.EventId = Event.Id) WHERE Event.Open = 1 AND TeamEvent." . $attribute . " = 0 ORDER BY TeamEvent.TeamId;");
                    $teams = array();
